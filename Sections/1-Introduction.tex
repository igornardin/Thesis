...
\begin{enumerate}
    \item Making online modifications in the power decisions given by the offline plan, coping with the uncertainty coming from renewable production and workload demand;
